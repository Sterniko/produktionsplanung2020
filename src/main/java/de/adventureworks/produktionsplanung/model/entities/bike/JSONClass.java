...
public class JSONClass {
    ...
    private static ArrayList<Ship> getShips(){
        ...
        shipList.add(new Ship("THALASSA NIKI III", LocalDate.of(2019, 8, 1), LocalDate.of(2019,8 , 30)));
        shipList.add(new Ship("CMA CGM JULES VERNE III", LocalDate.of(2019, 8,3 ), LocalDate.of(2019, 8, 4)));
        shipList.add(new Ship("CMA CGM LAPEROUSE III", LocalDate.of(2019,8 , 2), LocalDate.of(2019,8 , 1)));
        shipList.add(new Ship("EVER GENIUS IIII", LocalDate.of(2019, 8,8 ), LocalDate.of(2019,8 , 10)));
        shipList.add(new Ship("CMA CGM ZHENG HE IIII", LocalDate.of(2019,8 ,10 ), LocalDate.of(2019,8 , 9)));
        shipList.add(new Ship("APL VANDA III", LocalDate.of(2019,8 ,9 ), LocalDate.of(2019,8 , 8)));
        shipList.add(new Ship("EVER GRADE IIII", LocalDate.of(2019,8 , 15), LocalDate.of(2019,8 ,14 )));
        shipList.add(new Ship("CMA CGM ANTOINE DE SAINT EXUPE III", LocalDate.of(2019, 8,17 ), LocalDate.of(2019, 8, 16)));
        shipList.add(new Ship("CMA CGM MAGELLAN IIII", LocalDate.of(2019, 8, 16), LocalDate.of(2019, 8, 15)));
        shipList.add(new Ship("TITAN IIII", LocalDate.of(2019, 8, 22), LocalDate.of(2019,8 ,20 )));
        shipList.add(new Ship("CMA CGM LOUIS BLERIOT IIII", LocalDate.of(2019, 8,24 ), LocalDate.of(2019,8 , 25)));
        shipList.add(new Ship("EVER GOODS IIII", LocalDate.of(2019,8 ,29 ), LocalDate.of(2019, 8 ,28 )));
        shipList.add(new Ship("CMA CGM VASCO DE GAMA IIII", LocalDate.of(2019,9 ,1 ), LocalDate.of(2019,8 , 30)));
        shipList.add(new Ship("APL FULLERTON IIII", LocalDate.of(2019,8 , 30), LocalDate.of(2019,8 ,29 )));
        shipList.add(new Ship("CMA CGM JEAN MERMOZ IIII", LocalDate.of(2019, 9,8 ), LocalDate.of(2019, 9, 6)));
        shipList.add(new Ship("CMA CGM GEORG FORSTER IIII", LocalDate.of(2019,9,7 ), LocalDate.of(2019, 9,5 )));
        shipList.add(new Ship("EVER GOLDEN IIII", LocalDate.of(2019,9 , 13), LocalDate.of(2019, 9,11 )));
        shipList.add(new Ship("TEXAS TRIUMPH IIII", LocalDate.of(2019, 9,20 ), LocalDate.of(2019,9 ,18 )));
        shipList.add(new Ship("CMA CGM BOUGAINVILLE IIII", LocalDate.of(2019,9 ,22 ), LocalDate.of(2019,9, 20)));
        shipList.add(new Ship("CMA CGM ALEXANDER VON HUMBOLD IIII", LocalDate.of(2019, 9, 29), LocalDate.of(2019,9 , 27)));
